...
const Services = () => {
    ...
    for (let i = 0; i < totalSlides; i++) {
        ...
        slides.push({ id: `${startKey}-${endKey}`, items: services.slice(start, end) });
    }
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        {service.features.slice(0, 2).map((feature, idx) => (
                                            <div key={`${service.number}-${idx}`} className="flex items-center gap-2">
                ...
                <div className="items-center justify-center gap-3 mt-8 hidden md:flex">
                    {slides.map((slide) => (
                        <button
                            ...
                            className={`w-2 h-2 rounded-full transition-all duration-300 ${currentSlide === slides.indexOf(slide)
                                    ? "bg-[#ffb400] w-8"
