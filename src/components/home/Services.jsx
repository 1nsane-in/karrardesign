...
const Services = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            description: "Professional oversight of construction activities ensuring adherence to design specifications and quality standards.",
            features: ["Quality Control", "Safety Management", "Progress Monitoring", "Issue Resolution"],
            icon: "🏗️"
        },
        {
            number: "06",
            title: "Value Engineering",
            description: "Cost optimization strategies that maintain design integrity while maximizing value and efficiency.",
            features: ["Cost Analysis", "Alternative Solutions", "Efficiency Optimization", "Budget Management"],
            icon: "💎"
        },
        {
            number: "07",
            title: "Procurement Services",
            description: "Strategic sourcing and procurement of premium materials, furniture, and fixtures for luxury projects.",
            features: ["Vendor Selection", "Material Sourcing", "Cost Negotiation", "Quality Assurance"],
            icon: "🛍️"
        },
        {
            number: "08",
            title: "MEP Coordination",
            description: "Mechanical, Electrical, and Plumbing systems integration for seamless infrastructure implementation.",
            features: ["System Integration", "Technical Coordination", "Compliance Management", "Performance Optimization"],
            icon: "⚡"
        },
        {
            number: "09",
            title: "Sustainability Consulting",
            description: "Green building practices and sustainable design solutions for environmentally conscious developments.",
            features: ["LEED Certification", "Energy Efficiency", "Sustainable Materials", "Environmental Impact"],
            icon: "🌱"
        },
        {
            number: "10",
            title: "Client Representation",
            description: "Professional advocacy and representation services protecting client interests throughout the project lifecycle.",
            features: ["Contract Management", "Quality Advocacy", "Timeline Monitoring", "Cost Control"],
            icon: "🤝"
        },
        {
            number: "11",
            title: "Post-Completion Support",
            description: "Comprehensive maintenance and support services ensuring long-term satisfaction and property value.",
            features: ["Warranty Management", "Maintenance Planning", "Issue Resolution", "Upgrade Consultation"],
            icon: "🔧"
        },
        {
            number: "12",
            title: "Design Consultation",
            description: "Expert advisory services for design decisions, material selection, and aesthetic coordination.",
            features: ["Design Advisory", "Material Consultation", "Color Coordination", "Style Guidance"],
            icon: "💡"
        }
    ];
