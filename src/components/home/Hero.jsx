    ...
    >
              ...
              >
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-tan-pearl text-white leading-tight">
                        {experiences[currentIndex].title}
                      </h2>
                    </div>

                    <p className="text-lg text-white font-light leading-relaxed max-w-md mx-auto text-center">
                ...
                >
                  <div className="group cursor-pointer inline-flex items-center gap-4">
                    <span className="text-sm uppercase tracking-wider text-white group-hover:text-[#ffb400] transition-colors duration-300">
                      Explore Our Work
                    </span>
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-[10px] uppercase tracking-[0.2em] text-white rotate-90 origin-center">
            Scroll
          </span>
        </div>
      </motion.div>
