...
const CompanyPartners = () => {
    ...
    return (
        <section ref={containerRef} className="relative py-20 bg-zinc-100 overflow-hidden">
            {/* Content */}
            <motion.div
                style={{ opacity }}
            ...
            >
                ...
                <div className="text-center mb-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <span className="text-xs uppercase tracking-[0.3em] text-zinc-600">Trusted Partners</span>
                        <div className="w-12 h-px bg-[#ffb400]" />
                    </motion.div>
                    ...
                    >
                        Proud to work alongside the region's most prestigious developers, hospitality groups, and luxury brands
                    </motion.p>
                </div>
                ...
                >
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="text-center">
                            <div className="text-3xl lg:text-4xl font-tan-pearl text-[#ffb400] mb-2">50+</div>
                            <div className="text-sm text-zinc-600">Trusted Partners</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl lg:text-4xl font-tan-pearl text-[#ffb400] mb-2">200+</div>
                            <div className="text-sm text-zinc-600">Completed Projects</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl lg:text-4xl font-tan-pearl text-[#ffb400] mb-2">3</div>
                            <div className="text-sm text-zinc-600">Countries</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl lg:text-4xl font-tan-pearl text-[#ffb400] mb-2">20+</div>
