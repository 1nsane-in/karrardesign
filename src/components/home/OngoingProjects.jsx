    ...
    const ongoingProjects = [
        {
            ...
            area: "8,500 sq ft",
            team: "12 specialists",
            description: "Luxury residential villa featuring contemporary design with traditional Arabian elements. Currently in final stages of interior installation and finishing work.",
            milestones: [
        ...
        },
        {
            ...
            area: "25,000 sq ft",
            team: "28 specialists",
            description: "Premium hospitality suites with panoramic sea views and state-of-the-art amenities. Currently progressing through structural and MEP installation phases.",
            milestones: [
        ...
        },
        {
            ...
            area: "65,000 sq ft",
            team: "35 specialists",
            description: "Modern corporate headquarters featuring sustainable design principles and innovative workspace solutions for the digital age.",
            milestones: [
        ...
        },
        {
            ...
            area: "85,000 sq ft",
            team: "42 specialists",
            description: "Multi-level retail and dining complex with waterfront views, featuring innovative architectural design and premium commercial spaces.",
            milestones: [
        ...
        },
        {
            ...
            area: "12,000 sq ft",
            team: "18 specialists",
            description: "Ultra-luxury penthouse with bespoke finishes and panoramic city views, featuring custom-designed furniture and state-of-the-art technology.",
            milestones: [
        ...
        },
        {
            ...
            area: "95,000 sq ft",
            team: "55 specialists",
            description: "Contemporary cultural center celebrating local arts and heritage, featuring exhibition spaces, performance halls, and community workshops.",
            milestones: [
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div className="relative overflow-hidden">
                                        ...
                                        <div className="absolute bottom-4 left-4 right-4">
                                            <div className="flex items-center justify-between text-white mb-2">
                                                <div className="text-2xl font-tan-pearl">{project.id}</div>
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="bg-white rounded-lg p-3">
                                                ...
                                                <div className="text-sm font-semibold text-zinc-800">{project.budget}</div>
                                            </div>
                                            <div className="bg-white rounded-lg p-3">
                                                <div className="text-xs text-zinc-400 mb-1">Area</div>
                                                <div className="text-sm font-semibold text-zinc-800">{project.area}</div>
                                            </div>
                                            <div className="bg-white rounded-lg p-3">
                                        ...
                                        {/* Current Milestones */}
                                        <div className="pt-2">
                                            <div className="text-xs text-zinc-500 mb-2">Current Milestone</div>
                                            {project.milestones.filter(m => m.status === 'active').map((milestone, i) => (
                                                <div key={i} className="flex items-center gap-2">
                                                    <div className="w-2 h-2 bg-[#ffb400] rounded-full animate-pulse" />
                                                    <span className="text-sm font-medium text-[#ffb400]">{milestone.name}</span>
                ...
                <div className="text-center mt-4">
                    <span className="text-sm text-zinc-500">
                        {currentSlide + 1} of {totalSlides} • {ongoingProjects.length} Active Projects
                    </span>
                </div>
            </div>
