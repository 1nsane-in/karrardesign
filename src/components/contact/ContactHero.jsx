...
const ContactHero = memo(() => {
  return (
    <div className="max-w-6xl mx-auto pt-36 sm:pt-24 md:pt-32 lg:pt-44 px-4 sm:px-6 lg:px-0 text-center">
      ...
      <div className="font-gloock text-center flex flex-col items-center justify-center w-fit mx-auto">
