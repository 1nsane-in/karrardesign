...
const Karrar = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto mt-16 sm:mt-20 md:mt-24 lg:mt-32 px-4 sm:px-6 lg:px-0 text-center">
        ...
        >
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-zinc-800 mb-2 sm:mb-3">Timeless Elegance</h3>
            <p className="text-zinc-600 leading-relaxed">
              Every design transcends trends, creating spaces that remain sophisticated and relevant for generations.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-3">Uncompromising Quality</h3>
            <p className="text-zinc-600 leading-relaxed">
              Premium materials, masterful craftsmanship, and attention to the finest details in every project.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-3">Seamless Execution</h3>
            <p className="text-zinc-600 leading-relaxed">
              Precision project management ensuring on-time delivery and budget adherence without compromising vision.
            </p>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="max-w-6xl mx-auto mt-16 sm:mt-20 md:mt-24 lg:mt-32 px-4 sm:px-6 lg:px-0 text-center">
        ...
        >
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-zinc-600">Industry Recognition</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-zinc-600">Technical Excellence</p>
          </motion.div>
        </motion.div>
        ...
        >
          These honors reflect the trust our distinguished clients and industry partners place in our expertise.
        </motion.p>
      </div>
      ...
      >
        <img src={KarrarLogo} alt="Karrar Logo" className="w-5 h-5 sm:w-6 sm:h-6 opacity-30" />
        <img src={KarrarLogo} alt="Karrar Logo" className="w-5 h-5 sm:w-6 sm:h-6 opacity-40" />
        <img src={KarrarLogo} alt="Karrar Logo" className="w-5 h-5 sm:w-6 sm:h-6 opacity-30" />
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto mt-12 sm:mt-16 lg:mt-24 px-4 sm:px-6 lg:px-0 text-center">
        ...
        >
          ...
          >
            We are more than a design and fit-out company, we are <strong className="text-zinc-800 hover:text-[#ffb400] transition-colors duration-300 cursor-pointer">partners in creating legacies</strong>. Each space we design and manage is a reflection of our client&apos;s individuality, elevated through luxury craftsmanship and world-class project execution.
          </motion.p>
          ...
          >
            With projects spanning <strong className="text-zinc-800 hover:text-[#ffb400] transition-colors duration-300 cursor-pointer">luxurious mansions, high-rise residences, five-star hotels, and global retail spaces</strong>, our legacy is built on trust, expertise, and results that exceed expectations.
          </motion.p>
          ...
          >
            <p className="text-base sm:text-lg md:text-xl lg:text-[28px] leading-tight sm:leading-tight md:leading-tight lg:leading-[32px] font-tan-pearl mb-1 sm:mb-2" style={{ color: '#ffb400' }}>
              At Karrar Design Projects,
            </p>
            <p className="text-base sm:text-lg md:text-xl lg:text-[28px] leading-tight sm:leading-tight md:leading-tight lg:leading-[32px] font-tan-pearl italic" style={{ color: '#ffb400' }}>
