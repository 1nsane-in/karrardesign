...
const projectData = {
  abundance: {
    ...
    description:
      "A stunning residential project that embodies luxury and comfort. This project showcases our ability to create spaces that are both functional and aesthetically pleasing, with careful attention to every detail.",
    fullDescription:
  ...
  "a-mews": {
    ...
    description:
      "An elegant mews house transformation in one of London's most prestigious areas. This project demonstrates our expertise in working with heritage buildings while introducing contemporary design elements.",
    fullDescription:
      "Nestled in the prestigious Regent's Park area, A Mews represents a masterful blend of historical charm and contemporary sophistication. This heritage mews house required delicate restoration work while introducing modern amenities and design sensibilities. Our approach preserved the building's character while creating bright, airy spaces that meet the demands of contemporary living.",
    images: [
      "https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=1200&q=80",
  ...
  "satin-house": {
    ...
    description:
      "A contemporary residential project that showcases innovative design solutions in an urban setting. The project emphasizes clean lines, natural materials, and sophisticated lighting design.",
    fullDescription:
      "Satin House stands as a testament to modern urban living, where every square meter has been optimized for both functionality and beauty. Located in the dynamic Aldgate district, this project challenged us to create a serene retreat amidst the bustling city environment. The design features flowing open-plan spaces, floor-to-ceiling windows, and a carefully curated selection of materials that create warmth and sophistication.",
    images: [
      "https://images.unsplash.com/photo-1472220625704-91e1462799b2?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=1200&q=80",
