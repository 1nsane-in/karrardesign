        ...
        >
          <div className="max-w-4xl mx-auto">
            <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-zinc-700">
              Every project tells a story of precision, creativity, and unmatched craftsmanship.
            </p>
          </div>
        </motion.div>
        {/* Project SVG */}
              ...
              <div className="mt-2 sm:mt-3 w-full flex justify-between items-end">
                <div className="flex flex-col gap-0 text-left">
                  <div className="flex items-center gap-2 mb-1">
                    <img src={KarrarLogo} alt="Karrar Logo" className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 opacity-60" />
                    <span className="block text-sm sm:text-base lg:text-lg font-bold mt-0">{project.title}</span>
                  </div>
                  <span className="block text-xs sm:text-sm text-zinc-600">{project.location}</span>
                </div>
                <span className="text-xs sm:text-sm lg:text-base font-semibold text-right flex flex-col items-end">
                  ...
                  <span className="text-xs sm:text-sm font-normal text-zinc-600">{project.service}</span>
                </span>
              </div>
            </Link>
          ))}
      ...
      <section className="philosophy-section mt-20 sm:mt-24 lg:mt-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-tan-pearl text-zinc-700 mb-6">Project Philosophy</h2>
            <p className="text-xl sm:text-2xl lg:text-3xl italic text-zinc-600 mb-10 font-light">Every Detail Matters</p>

            <div className="max-w-4xl mx-auto">
              <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed text-zinc-700 font-light">
                We don't just design spaces, we <strong className="font-semibold hover:text-[#ffb400] transition-colors duration-300 cursor-pointer">curate experiences</strong>. From consultation to completion, our process ensures that each project embodies <strong className="font-semibold hover:text-[#ffb400] transition-colors duration-300 cursor-pointer">function, form, and timeless elegance</strong>. Whether a private residence, a five-star hotel, or a high-end retail environment, we approach each project as a unique story waiting to be told.
              </p>
            </div>
          </div>
